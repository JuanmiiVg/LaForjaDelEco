...
<body>
    ...
    <div id="arma" class="formulario" style="display:none;">
        ...
        <form action method="POST" enctype="multipart/form-data">
            ...
            <input type="radio" name="tamano" id="tamano" value="1">A una mano <input type="radio" name="tamano" id="tamano" value="2">A dos manos<br>
    ...
    <div id="pocion" class="formulario" style="display:none;">
    ...
    <div id="ingrediente" class="formulario" style="display:none;">
    ...
    <div id="material" class="formulario" style="display:none;">
